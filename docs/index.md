...
18. [`docs/gateway_contracts.md`](gateway_contracts.md) for the frozen gateway result, error, and mutation-plan communication contract.
19. [`docs/studycard_runtime.md`](studycard_runtime.md) for the real file-backed StudyCard runtime slice.
20. [`docs/datasetcard_runtime.md`](datasetcard_runtime.md) for the real file-backed DatasetCard runtime slice and the thin public CLI entry point.
21. [`docs/claimcard_runtime.md`](claimcard_runtime.md) for the real file-backed ClaimCard runtime slice.
22. [`docs/ingest_studycard_runtime.md`](ingest_studycard_runtime.md) for the first real StudyCard ingest runtime path.
23. [`docs/public_ingest_studycard_cli.md`](public_ingest_studycard_cli.md) for the first public StudyCard command surface.
24. [`docs/public_ingest_studycard_from_file.md`](public_ingest_studycard_from_file.md) for the public StudyCard single-file ingest surface.
25. [`docs/public_ingest_datasetcard_cli.md`](public_ingest_datasetcard_cli.md) for the public DatasetCard flag-based command surface.
26. [`docs/public_ingest_datasetcard_from_file.md`](public_ingest_datasetcard_from_file.md) for the public DatasetCard single-file ingest surface.
27. [`docs/public_update_studycard_cli.md`](public_update_studycard_cli.md) for the public StudyCard update surface.
28. [`docs/public_update_datasetcard_cli.md`](public_update_datasetcard_cli.md) for the public DatasetCard update surface.
29. [`docs/public_ingest_claimcard_cli.md`](public_ingest_claimcard_cli.md) for the public ClaimCard flag-based command surface.
30. [`docs/public_ingest_claimcard_from_file.md`](public_ingest_claimcard_from_file.md) for the public ClaimCard single-file ingest surface.
31. [`docs/public_update_claimcard_cli.md`](public_update_claimcard_cli.md) for the public ClaimCard update surface.
32. [`docs/public_show_cli.md`](public_show_cli.md) for the first public read-by-id command surface.
33. [`docs/public_list_cli.md`](public_list_cli.md) for the first public discovery command surface.
34. [`docs/public_delete_cli.md`](public_delete_cli.md) for the first public referentially-aware delete command surface.
35. [`docs/api_specs.md`](api_specs.md) for the current CLI contract and the boundary between implemented public commands and reserved internal command families.
36. [`docs/cli_command_contracts.md`](cli_command_contracts.md) for the frozen command-family contracts and module responsibilities.
37. [`docs/data_contracts.md`](data_contracts.md) for the high-level contract categories and the remaining non-frozen object families.
38. [`docs/audit_policy.md`](audit_policy.md) for routine review policy and the distinction from future escalated review.
...
`delete_locking_policy`, `gateway_contracts`, `studycard_runtime`,
